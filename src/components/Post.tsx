...
export function Post({author, publishedAt, content, citation, bgImgSrc}: PostProps){
         ...
         <div className={styles.content}>
            ...
            <p>{
               citation.map(citations => {
                  if(citations.type == 'paragraph') {
                     return (
                        <span key={citations.content}>
                           {citations.content + ' '}
                        </span>
                     );
                  } else if(citations.type == 'link') {
                     return(
                        <a href='#' key={citations.content}>
                           {citations.content + ' '}
                        </a>
                     );
                  }
